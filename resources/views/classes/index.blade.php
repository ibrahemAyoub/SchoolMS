...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-diagram-3"></i> الصفوف</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">الرئيسية</a></li>
                            <li class="breadcrumb-item active" aria-current="page">الصفوف</li>
                        </ol>
                    </nav>
                    <div class="row">
                                    ...
                                    <div class="card my-3">
                                        <div class="card-header bg-transparent">
                                            <ul class="nav nav-tabs card-header-tabs">
                                                ...
                                                <li class="nav-item">
                                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class{{$school_class->id}}-syllabus" role="tab" aria-current="false"><i class="bi bi-journal-text"></i> المنهاج الدراسي</button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class{{$school_class->id}}-courses" role="tab" aria-current="false"><i class="bi bi-journal-medical"></i> المواد</button>
                                                </li>
                                            </ul>
                                        </div>
                                                                        ...
                                                                        <div id="accordionClass{{$school_class->id}}Section{{$school_section->id}}" class="accordion-collapse collapse" aria-labelledby="headingClass{{$school_class->id}}Section{{$school_section->id}}" data-bs-parent="#accordionClass{{$school_class->id}}">
                                                                            <div class="accordion-body">
                                                                                <p class="lead d-flex justify-content-between">
                                                                                    <span>رقم الغرفة: {{$school_section->room_no}}</span>
                                                                                    @can('edit sections')
                                                                                    <span><a href="{{route('section.edit', ['id' => $school_section->id])}}" role="button" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i> تعديل</a></span>
                                                                                    @endcan
                                                                                </p>
                                                        ...
                                                        @foreach ($school_class->syllabi as $syllabus)
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{asset('storage/'.$syllabus->syllabus_file_path)}}" role="button" class="btn btn-sm btn-outline-primary"><i class="bi bi-download"></i> تحميل</a>
                                                                </div>
                                                            </td>
                                                            </tr>
                                                        @endforeach
                                                    ...
                                                    @isset($school_class->courses)
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @can('edit courses')
                                                                    <a href="{{route('course.edit', ['id' => $course->id])}}" class="btn btn-sm btn-outline-primary" role="button"><i class="bi bi-pencil"></i> تعديل</a>
                                                                    @endcan
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                        ...
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                            @isset($total_sections)
                                                <span>عدد الفئات: {{$total_sections}}</span>
                                            @endisset
                                            @can('edit classes')
                                            <span><a href="{{route('class.edit', ['id' => $school_class->id])}}" class="btn btn-sm btn-outline-primary" role="button"><i class="bi bi-pencil"></i> تعديل الصف</a></span>
                                            @endcan
                                        </div>
                                    </div>
                                </div>
