...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> إضافة امتحان</h1>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('exam.create')}}" method="POST">
                                    ...
                                    <div>
                                        <p>اختر الفصل الدراسي:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <p>عنوان الامتحان<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <label for="inputEnds" class="form-label">وقت الانتهاء<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
