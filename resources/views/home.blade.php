            ...
            <div class="row pt-3">
                <div class="col ps-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> الطلاب</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> المدرسين</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-diagram-3 me-3"></i> الصفوف</div>
                                        </div>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3">
                            <span class="ps-2 me-2">الطلاب %</span>
                            <span class="badge rounded-pill border" style="background-color: #0678c8;">ذكر</span>
                            <span class="badge rounded-pill border" style="background-color: #49a4fe;">أنثى</span>
                        </div>
                        @php
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent"><i class="bi bi-calendar-event me-2"></i> رزنامة الأعمال</div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent d-flex justify-content-between"><span><i class="bi bi-megaphone me-2"></i> الملاحظات</span> {{ $notices->links() }}</div>
                                <div class="card-body p-0 text-dark">
                                    <div>
                                        ...
                                        <div class="accordion accordion-flush" id="noticeAccordion">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-heading{{$notice->id}}">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{$notice->id}}" aria-expanded={{($loop->first)?"true":"false"}} aria-controls="flush-collapse{{$notice->id}}">
                                                        تاريخ الإضافة: {{$notice->created_at}}
                                                    </button>
                                                </h2>
                                            ...
                                            @endisset
                                            @if(count($notices) < 1)
                                                <div class="p-3">لا يوجد ملاحظات</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
